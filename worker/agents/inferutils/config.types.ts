...
export enum AIModels {
    ...
    GEMINI_2_0_FLASH = '[gemini]models/gemini-2.0-flash',
    GEMINI_2_5_PRO = '[gemini]models/gemini-2.5-pro',
    GEMINI_2_5_FLASH = '[gemini]models/gemini-2.5-flash',
    GEMINI_2_5_FLASH_LITE = '[gemini]models/gemini-2.5-flash-lite',
