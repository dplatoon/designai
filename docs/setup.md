# DesignAI Setup Guide

Local first time setup guide for DesignAI - get your AI coding platform running locally and also ready to be deployed.
...
The fastest way to get DesignAI running is with our automated setup script:
...
- KV Namespace for `DesignAIStore`
- D1 Database named `designai-db`
- R2 Bucket named `designai-templates`
...
- **"Dispatch namespace not found"**: Deploy your DesignAI project to Cloudflare at least once first
...
2. **Visit** `http://localhost:5173` to access DesignAI
...
The DesignAI setup script provides a comprehensive, intelligent configuration experience:
...
- Local-only development isn't yet supported for this in designai
